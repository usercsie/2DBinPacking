...
public class MaxRectsBinPack
{
    ...
    public List<RectangleF> usedRectangles = new List<RectangleF>();
    public List<RectangleF> freeRectangles = new List<RectangleF>();
    ...
    public RectangleF Insert(int width, int height, FreeRectChoiceHeuristic method)
    {
        RectangleF newNode = new RectangleF();
    ...
    public void Insert(List<RectangleF> rects, List<RectangleF> dst, FreeRectChoiceHeuristic method)
    {
        dst.Clear();
        ...
        while (rects.Count > 0)
        {
            ...
            int bestRectIndex = -1;
            RectangleF bestNode = new RectangleF();

            for (int i = 0; i < rects.Count; ++i)
            {
                int score1 = 0;
                int score2 = 0;
                RectangleF newNode = ScoreRect((int)rects[i].Width, (int)rects[i].Height, method, ref score1, ref score2);
    ...
    void PlaceRect(RectangleF node)
    {
        int numRectanglesToProcess = freeRectangles.Count;
        for (int i = 0; i < numRectanglesToProcess; ++i)
        {
    ...
    RectangleF ScoreRect(int width, int height, FreeRectChoiceHeuristic method, ref int score1, ref int score2)
    {
        RectangleF newNode = new RectangleF();
        score1 = int.MaxValue;
        score2 = int.MaxValue;
    ...
    RectangleF FindPositionForNewNodeBottomLeft(int width, int height, ref int bestY, ref int bestX)
    {
        RectangleF bestNode = new RectangleF();
    ...
    RectangleF FindPositionForNewNodeBestShortSideFit(int width, int height, ref int bestShortSideFit, ref int bestLongSideFit)
    {
        RectangleF bestNode = new RectangleF();
        //memset(&bestNode, 0, sizeof(Rect));
    ...
    RectangleF FindPositionForNewNodeBestLongSideFit(int width, int height, ref int bestShortSideFit, ref int bestLongSideFit)
    {
        RectangleF bestNode = new RectangleF();
        //memset(&bestNode, 0, sizeof(Rect));
    ...
    RectangleF FindPositionForNewNodeBestAreaFit(int width, int height, ref int bestAreaFit, ref int bestShortSideFit)
    {
        RectangleF bestNode = new RectangleF();
        //memset(&bestNode, 0, sizeof(Rect));
    ...
    RectangleF FindPositionForNewNodeContactPoint(int width, int height, ref int bestContactScore)
    {
        RectangleF bestNode = new RectangleF();
        //memset(&bestNode, 0, sizeof(Rect));
    ...
    bool SplitFreeNode(RectangleF freeNode, ref RectangleF usedNode)
    {
    ...
    bool IsContainedIn(RectangleF a, RectangleF b)
    {
